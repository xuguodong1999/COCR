...
//#define CHECK(...) DOCTEST_CHECK(__VA_ARGS__) // FIXME-disable it to avoid conflict with libtorch
...
//#define CHECK_EQ(...) DOCTEST_CHECK_EQ(__VA_ARGS__) // FIXME-disable it to avoid conflict with libtorch
#define REQUIRE_EQ(...) DOCTEST_REQUIRE_EQ(__VA_ARGS__)
#define WARN_NE(...) DOCTEST_WARN_NE(__VA_ARGS__)
//#define CHECK_NE(...) DOCTEST_CHECK_NE(__VA_ARGS__) // FIXME-disable it to avoid conflict with libtorch
#define REQUIRE_NE(...) DOCTEST_REQUIRE_NE(__VA_ARGS__)
#define WARN_GT(...) DOCTEST_WARN_GT(__VA_ARGS__)
//#define CHECK_GT(...) DOCTEST_CHECK_GT(__VA_ARGS__) // FIXME-disable it to avoid conflict with libtorch
#define REQUIRE_GT(...) DOCTEST_REQUIRE_GT(__VA_ARGS__)
#define WARN_LT(...) DOCTEST_WARN_LT(__VA_ARGS__)
//#define CHECK_LT(...) DOCTEST_CHECK_LT(__VA_ARGS__) // FIXME-disable it to avoid conflict with libtorch
#define REQUIRE_LT(...) DOCTEST_REQUIRE_LT(__VA_ARGS__)
#define WARN_GE(...) DOCTEST_WARN_GE(__VA_ARGS__)
//#define CHECK_GE(...) DOCTEST_CHECK_GE(__VA_ARGS__) // FIXME-disable it to avoid conflict with libtorch
#define REQUIRE_GE(...) DOCTEST_REQUIRE_GE(__VA_ARGS__)
#define WARN_LE(...) DOCTEST_WARN_LE(__VA_ARGS__)
//#define CHECK_LE(...) DOCTEST_CHECK_LE(__VA_ARGS__) // FIXME-disable it to avoid conflict with libtorch
