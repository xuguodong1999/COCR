...
namespace item {
	 ...
	 */
	template <class ProductType_t> class IProductRegistrar {
	public:
	...
	template <class ProductType_t> class ProductFactory {
	public:
	...
	template <class ProductType_t, class ProductImpl_t> class ProductRegistrar : public IProductRegistrar<ProductType_t> {
	public:
