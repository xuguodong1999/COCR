...
namespace OpenBabel {
    ...
    public:
        ...
        virtual const std::string &GetValue() const { return (_data); }
    };
    ...
    public:
        ...
        virtual OBGenericData *Clone(OBBase * /*parent*/) const { return new OBPairTemplate<ValueT>(*this); }
    ...
    public:
        ...
        std::vector<OBRing *>::iterator BeginRings() { return (_vr.begin()); }

        std::vector<OBRing *>::iterator EndRings() { return (_vr.end()); }
    ...
    public:
        ...
        */
        ...
        void SetSpaceGroup(const std::string sg) {
            _spaceGroup = SpaceGroup::GetSpaceGroup(sg);
            _spaceGroupName = sg;
        }
    ...
    public:
        ...
        void SetVelocities(std::vector<std::vector<vector3> > vv) { _vVelocity = vv; }

        void SetDisplacements(std::vector<std::vector<vector3> > vd) { _vDisplace = vd; }
        ...
        std::vector<std::vector<vector3> > GetVelocities() { return _vVelocity; }

        std::vector<std::vector<vector3> > GetDisplacements() { return _vDisplace; }
    ...
    public:
        ...
        virtual OBGenericData *Clone(OBBase *) const { return new OBVibrationData(*this); }
        ...
        std::vector<std::vector<vector3> > GetLx() const { return this->_vLx; }

        std::vector<double> GetFrequencies() const { return this->_vFrequencies; }

        std::vector<double> GetIntensities() const { return this->_vIntensities; }

        std::vector<double> GetRamanActivities() const { return this->_vRamanActivities; }
    ...
    public:
        ...
        virtual OBGenericData *Clone(OBBase *) const { return new OBDOSData(*this); }
        ...
        double GetFermiEnergy() const { return this->_fermi; }

        std::vector<double> GetEnergies() const { return this->_vEnergies; }

        std::vector<double> GetDensities() const { return this->_vDensities; }

        std::vector<double> GetIntegration() const { return this->_vIntegration; }
    };
    ...
    public:
        ...
        virtual OBGenericData *Clone(OBBase *) const { return new OBOrbitalData(*this); }

        OBOrbitalData &operator=(const OBOrbitalData &);

        void SetAlphaOrbitals(std::vector<OBOrbital> orbitalList) { _alphaOrbitals = orbitalList; }

        void SetBetaOrbitals(std::vector<OBOrbital> orbitalList) { _betaOrbitals = orbitalList; }
        ...
        void SetOpenShell(bool openShell) { _openShell = openShell; }
        ...
        void LoadClosedShellOrbitals(std::vector<double> energies, std::vector<std::string> symmetries,
                                     unsigned int alphaHOMO);

        //! \brief Convenience function to load alpha orbitals in an open-shell calculation
        void
        LoadAlphaOrbitals(std::vector<double> energies, std::vector<std::string> symmetries, unsigned int alphaHOMO);
    ...
    public:
        OBElectronicTransitionData() : OBGenericData("ElectronicTransitionData",
                                                     OBGenericDataType::ElectronicTransitionData) {}

        virtual ~OBElectronicTransitionData() {}

        virtual OBGenericData *Clone(OBBase *) const { return new OBElectronicTransitionData(*this); }
        ...
        std::vector<double> GetWavelengths() const { return this->_vWavelengths; }

        std::vector<double> GetForces() const { return this->_vForces; }

        std::vector<double> GetEDipole() const { return this->_vEDipole; }

        std::vector<double> GetRotatoryStrengthsVelocity() const { return this->_vRotatoryStrengthsVelocity; }

        std::vector<double> GetRotatoryStrengthsLength() const { return this->_vRotatoryStrengthsLength; }
    };
    ...
    public:
        enum RType {
            UNKNOWN, ASYMMETRIC, SYMMETRIC, LINEAR
        };
        ...
        virtual OBGenericData *Clone(OBBase *) const { return new OBRotationData(*this); }
    ...
    public:
        ...
        virtual OBGenericData *Clone(OBBase *) const { return new OBVectorData(*this); }

        void SetData(double x, double y, double z) { _vec = vector3(x, y, z); }

        void SetData(vector3 data) { _vec = data; }

        vector3 GetData() const { return _vec; }
    ...
    public:
        ...
        virtual OBGenericData *Clone(OBBase *) const { return new OBMatrixData(*this); }

        void SetData(matrix3x3 data) { _matrix = data; }

        matrix3x3 GetData() const { return _matrix; }
