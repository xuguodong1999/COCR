...
namespace OpenBabel {
    ...
    public:
        ...
        virtual const char *SpecificationURL() { return "http://www.scm.com/"; }; //optional
    ...
    public:
        ...
        virtual const char *
        SpecificationURL() { return "http://www.scm.com/Doc/Doc2007.01/ADF/ADFUsersGuide/page32.html"; }; //optional

        //*** This section identical for most OBMol conversions ***
        ////////////////////////////////////////////////////
        /// The "API" interface functions
        virtual bool ReadMolecule(OBBase *pOb, OBConversion *pConv) { return false; }
    ...
    public:
        ...
        virtual const char *SpecificationURL() { return "https://www.scm.com/product/band_periodicdft/"; }; //optional
    ...
    public:
        ...
        virtual const char *SpecificationURL() { return "https://www.scm.com/product/dftb/"; }; //optional
    ...
    public:
        ...
        virtual bool WriteMolecule(OBBase *, OBConversion *) { return false; }

    private:
        ///Utility function that eats all the remaining characters on the current and next line.
        void eol(istream &is) const {
            string s;
            getline(is, s);
            getline(is, s);
        }
...
//------------------------------------------------------------------------------
    ...
    bool OBT41Format::ReadBinary(OBBase *pOb, OBConversion *pConv) {
        obErrorLog.ThrowError(__FUNCTION__,
                              "OpenBabel does not currently support the TAPE41 binary format. Please use dmpkf to convert to ASCII.",
                              obError);
        return false;
    }
...
//------------------------------------------------------------------------------
    bool OBT41Format::ReadSumFragGrid(istream &is, OBGridData &t41Data) const {
        ...
        is >> buf;
        const string label = sumfrag + ' ' + buf;
        cout << label << endl;
        eol(is);
        if (!is) return false;
        const int numPoints = t41Data.GetNumberOfPoints();
