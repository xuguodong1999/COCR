...
namespace OpenBabel {
    ...
    void CommandPainter::SetFillColor(const OBColor &color) {
        m_ofs << "SetFillColor " << color.red << " " << color.green << " " << color.blue << " " << color.alpha
              << " (rgba)" << endl;
    }

    void CommandPainter::SetFillRadial(const OBColor &start, const OBColor &end) {
        m_ofs << "SetFillRadial" << start.red << " " << start.green << " " << start.blue << " " << start.alpha
              << " (rgba) to ";
    ...
    void CommandPainter::SetPenColor(const OBColor &color) {
        m_ofs << "SetPenColor " << color.red << " " << color.green << " " << color.blue << " " << color.alpha
              << " (rgba)" << endl;
    }
