...
namespace {
    void test_add1() {
        ...
        for (size_t i = 0; i < 4; ++i) {
            for (size_t j = 0; j < 5; ++j) {
                REQUIRE(add_r(i, j) == rm1(i, j) + rm2(i, j));
            }
        }
    ...
    void test_add4() {
        ...
        REQUIRE(add.RowNum() == 4);
        REQUIRE(add.ColNum() == 5);
        REQUIRE(add.BatchNum() == 7);

        for (size_t b = 0; b < 7; ++b) {
            for (size_t i = 0; i < 4; ++i) {
                for (size_t j = 0; j < 5; ++j) {
                    REQUIRE(add_r[b](i, j) == rm1[b](i, j) + rm2(i, j));
                }
            }
        }
        ...
        auto add2 = rm2 + rm1;
        add_r = Evaluate(add2);
        REQUIRE(add2.RowNum() == 4);
        REQUIRE(add2.ColNum() == 5);
        REQUIRE(add2.BatchNum() == 7);
    ...
    void test_add5() {
        ...
        for (size_t b = 0; b < 7; ++b) {
            for (size_t i = 0; i < 4; ++i) {
                for (size_t j = 0; j < 5; ++j) {
                    REQUIRE(add_r[b](i, j) == rm1[b](i, j) + rm2[b](i, j));
                }
            }
        }
        cout << "done" << endl;
    ...
    void test_add6() {
        ...
        for (size_t b = 0; b < 7; ++b) {
            for (size_t i = 0; i < 4; ++i) {
                for (size_t j = 0; j < 5; ++j) {
                    REQUIRE(add_r[b](i, j) == rm1[b](i, j) + 3);
                }
            }
        }
