...
namespace {
    void test_substract1() {
        ...
        for (size_t i = 0; i < 4; ++i) {
            for (size_t j = 0; j < 5; ++j) {
                REQUIRE(sub_r(i, j) == rm1(i, j) - rm2(i, j));
            }
        }
    ...
    void test_substract4() {
        cout << "Test substract case 4 ...\t";
        {
            ...
            for (size_t b = 0; b < 7; ++b) {
                for (size_t i = 0; i < 4; ++i) {
                    for (size_t j = 0; j < 5; ++j) {
                        REQUIRE(sub_r[b](i, j) == 2 - rm1[b](i, j));
                    }
                }
            }
        }
        {
            ...
            for (size_t b = 0; b < 7; ++b) {
                for (size_t i = 0; i < 4; ++i) {
                    for (size_t j = 0; j < 5; ++j) {
                        REQUIRE(sub_r[b](i, j) == rm1[b](i, j) - 2);
                    }
                }
            }
        }
    ...
    void test_substract5() {
        ...
        for (size_t b = 0; b < 7; ++b) {
            for (size_t i = 0; i < 4; ++i) {
                for (size_t j = 0; j < 5; ++j) {
                    REQUIRE(sub_r[b](i, j) == rm1[b](i, j) - rm2[b](i, j));
                }
            }
        }
        cout << "done" << endl;
    ...
    void test_substract6() {
        cout << "Test substract case 6 ...\t";
        {
            ...
            for (size_t b = 0; b < 7; ++b) {
                for (size_t i = 0; i < 4; ++i) {
                    for (size_t j = 0; j < 5; ++j) {
                        REQUIRE(sub_r[b](i, j) == rm1[b](i, j) - rm2(i, j));
                    }
                }
            }
        }

        {
            ...
            for (size_t b = 0; b < 7; ++b) {
                for (size_t i = 0; i < 4; ++i) {
                    for (size_t j = 0; j < 5; ++j) {
                        REQUIRE(sub_r[b](i, j) == rm2(i, j) - rm1[b](i, j));
                    }
                }
            }
        }
