    ...
    void test_mul1() {
        ...
        for (size_t i = 0; i < 4; ++i) {
            for (size_t j = 0; j < 5; ++j) {
                REQUIRE(mul_r(i, j) == rm1(i, j) * rm2(i, j));
            }
        }
    ...
    void test_mul4() {
        cout << "Test element mul case 4 ...\t";
        {
            ...
            for (size_t b = 0; b < 7; ++b) {
                for (size_t i = 0; i < 4; ++i) {
                    for (size_t j = 0; j < 5; ++j) {
                        REQUIRE(mul_r[b](i, j) == rm1(i, j) * rm2[b](i, j));
                    }
                }
            }
        }
    ...
    void test_mul5() {
        cout << "Test element mul case 5 ...\t";
        {
            ...
            for (size_t b = 0; b < 7; ++b) {
                for (size_t i = 0; i < 4; ++i) {
                    for (size_t j = 0; j < 5; ++j) {
                        REQUIRE(mul_r[b](i, j) == rm1[b](i, j) * 13);
                    }
                }
            }
        }
