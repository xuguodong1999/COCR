...
namespace {
    void test_negative_log_likelihood_derivative1() {
        ...
        for (size_t i = 0; i < 4; ++i) {
            for (size_t j = 0; j < 5; ++j) {
                REQUIRE(fabs(div_r(i, j) + 0.5 * rm1(i, j) / rm2(i, j)) < 0.001);
            }
        }
        ...
        for (size_t i = 0; i < 4; ++i) {
            for (size_t j = 0; j < 5; ++j) {
                REQUIRE(fabs(div_r(i, j) + 0.3 * rm1(i, j) / rm2(i, j)) < 0.001);
            }
        }
        cout << "done" << endl;
    }
    ...
    void test_negative_log_likelihood_derivative3() {
        ...
        for (size_t b = 0; b < 7; ++b) {
            for (size_t i = 0; i < 4; ++i) {
                for (size_t j = 0; j < 5; ++j) {
                    REQUIRE(fabs(div_r[b](i, j) + 0.5 * rm1[b](i, j) / rm2[b](i, j)) < 0.001);
                }
            }
        }
        cout << "done" << endl;
