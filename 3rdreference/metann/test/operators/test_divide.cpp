...
namespace {
    void test_div1() {
        ...
        for (size_t i = 0; i < 4; ++i) {
            for (size_t j = 0; j < 5; ++j) {
                REQUIRE(fabs(div_r(i, j) - rm1(i, j) / rm2(i, j)) < 0.001);
            }
        }
    ...
    void test_div2() {
        ...
        for (size_t i = 0; i < 4; ++i) {
            for (size_t j = 0; j < 5; ++j) {
                REQUIRE(fabs(div_r(i, j) - rm1(i, j) / 2) < 0.001);
            }
        }
        ...
        for (size_t i = 0; i < 4; ++i) {
            for (size_t j = 0; j < 5; ++j) {
                REQUIRE(fabs(div_r(i, j) - 3 / rm1(i, j)) < 0.001);
            }
        }
        cout << "done" << endl;
    }
    ...
    void test_div3() {
        ...
        for (size_t b = 0; b < 7; ++b) {
            for (size_t i = 0; i < 4; ++i) {
                for (size_t j = 0; j < 5; ++j) {
                    REQUIRE(fabs(div_r[b](i, j) - rm1[b](i, j) / rm2[b](i, j)) < 0.001);
                }
            }
        }
    ...
    void test_div4() {
        cout << "Test divide case 4 ...\t";
        {
            ...
            for (size_t b = 0; b < 7; ++b) {
                for (size_t i = 0; i < 4; ++i) {
                    for (size_t j = 0; j < 5; ++j) {
                        REQUIRE(fabs(div_r[b](i, j) - rm1[b](i, j) / rm2(i, j)) < 0.001);
                    }
                }
            }
        }

        {
            ...
            for (size_t b = 0; b < 7; ++b) {
                for (size_t i = 0; i < 4; ++i) {
                    for (size_t j = 0; j < 5; ++j) {
                        REQUIRE(fabs(div_r[b](i, j) - rm2(i, j) / rm1[b](i, j)) < 0.001);
                    }
                }
            }
        }
    ...
    void test_div5() {
        cout << "Test divide case 5 ...\t";
        {
            ...
            for (size_t b = 0; b < 7; ++b) {
                for (size_t i = 0; i < 4; ++i) {
                    for (size_t j = 0; j < 5; ++j) {
                        REQUIRE(fabs(div_r[b](i, j) - rm1[b](i, j) / 3) < 0.001);
                    }
                }
            }
        }

        {
            ...
            for (size_t b = 0; b < 7; ++b) {
                for (size_t i = 0; i < 4; ++i) {
                    for (size_t j = 0; j < 5; ++j) {
                        REQUIRE(fabs(div_r[b](i, j) - 3 / rm1[b](i, j)) < 0.001);
                    }
                }
            }
        }
