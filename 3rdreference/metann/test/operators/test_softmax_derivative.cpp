...
namespace {
    void test_softmax_derivative1() {
        ...
        for (size_t i = 0; i < 4; ++i) {
            REQUIRE(fabs(t_r(0, i) - helper(0, i)) < 0.0001);
        }
    ...
    void test_softmax_derivative3() {
        cout << "Test softmax derivative case 3 ...\t";
        {
            ...
            auto layer2GradOutput = layer2.FeedBackward(
                    LayerIO::Create().Set<LayerIO>(Scalar<float>(0.7))).Get<CostLayerIn>();
            auto layer1GradOutput = layer1.FeedBackward(
                    LayerIO::Create().Set<LayerIO>(layer2GradOutput)).Get<LayerIO>();
            ...
            for (size_t i = 0; i < 5; ++i) {
                ...
                REQUIRE(fabs(check(0, i) - compare * 0.7f) <= 0.0001);
            }
        }
        {
            ...
            for (size_t b = 0; b < 7; ++b) {
                ...
                for (size_t i = 0; i < 5; ++i) {
                    ...
                    REQUIRE(fabs(check[b](0, i) - compare * 0.7f) <= 0.0001);
                }
            }
        }
        cout << "done" << endl;
    ...
    void test_softmax_derivative5() {
        ...
        for (size_t b = 0; b < 7; ++b) {
            ...
            for (size_t i = 0; i < 4; ++i) {
                REQUIRE(fabs(t_r[b](0, i) - helper(0, i)) < 0.0001);
            }
        }
        cout << "done" << endl;
    }
