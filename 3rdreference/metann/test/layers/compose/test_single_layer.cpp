...
namespace {
    void test_single_layer1() {
        ...
        REQUIRE(fabs(out(0, 0) - (1 / (1 + exp(-0.75)))) < 0.00001);
        REQUIRE(fabs(out(0, 1) - (1 / (1 + exp(-0.91)))) < 0.00001);
        REQUIRE(fabs(out(0, 2) - (1 / (1 + exp(-1.07)))) < 0.00001);
        ...
        REQUIRE(params.find("root-weight") != params.end());
        REQUIRE(params.find("root-bias") != params.end());
    ...
    void test_single_layer2() {
        ...
        REQUIRE(fabs(out(0, 0) - tanh(0.75)) < 0.00001);
        REQUIRE(fabs(out(0, 1) - tanh(0.91)) < 0.00001);
        REQUIRE(fabs(out(0, 2) - tanh(1.07)) < 0.00001);
    ...
    void test_single_layer3() {
        ...
        REQUIRE(fabs(out(0, 0) - (1 / (1 + exp(-0.05)))) < 0.00001);
        REQUIRE(fabs(out(0, 1) - (1 / (1 + exp(-0.11)))) < 0.00001);
        REQUIRE(fabs(out(0, 2) - (1 / (1 + exp(-0.17)))) < 0.00001);
    ...
    void test_single_layer4() {
        ...
        for (auto &p: grad_collector) {
            ...
            if (w.RowNum() == w1.RowNum()) {
                ...
                REQUIRE(fabs(info(0, 0) - 0.0414 * 0.1) < 0.00001);
                REQUIRE(fabs(info(1, 0) - 0.0414 * 0.2) < 0.00001);
                REQUIRE(fabs(info(0, 1) - 0.04706511 * 0.1) < 0.00001);
                REQUIRE(fabs(info(1, 1) - 0.04706511 * 0.2) < 0.00001);
                REQUIRE(fabs(info(0, 2) + 0.02852585 * 0.1) < 0.00001);
                REQUIRE(fabs(info(1, 2) + 0.02852585 * 0.2) < 0.00001);
            } else if (w.RowNum() == b1.RowNum()) {
                bias_update_valid = true;
                REQUIRE(fabs(info(0, 0) - 0.0414) < 0.00001);
                REQUIRE(fabs(info(0, 1) - 0.04706511) < 0.00001);
                REQUIRE(fabs(info(0, 2) + 0.02852585) < 0.00001);
            } else {
                REQUIRE(false);
            }
        }
        REQUIRE(bias_update_valid);
        REQUIRE(weight_update_valid);
