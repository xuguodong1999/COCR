...
namespace {
    void test_bias_layer1() {
        ...
        REQUIRE(fabs(res(0, 0) - input(0, 0) - weight(0, 0)) < 0.001);
        REQUIRE(fabs(res(1, 0) - input(1, 0) - weight(1, 0)) < 0.001);
    ...
    void test_bias_layer2() {
        ...
        auto res = Evaluate(out.Get<LayerIO>());
        REQUIRE(fabs(res(0, 0) - input(0, 0) - weight(0, 0)) < 0.001);
        REQUIRE(fabs(res(0, 1) - input(0, 1) - weight(0, 1)) < 0.001);
    ...
    void test_bias_layer3() {
        ...
        auto out = layer.FeedForward(bi);
        auto res = Evaluate(out.Get<LayerIO>());
        REQUIRE(fabs(res(0, 0) + 0.27f + 0.48f) < 0.001);
        REQUIRE(fabs(res(1, 0) + 0.41f + 0.13f) < 0.001);
        ...
        REQUIRE(fabs(w1(0, 0) + 0.48f) < 0.001);
        REQUIRE(fabs(w1(1, 0) + 0.13f) < 0.001);
        REQUIRE(fabs(g1(0, 0) + 0.0495f) < 0.001);
        REQUIRE(fabs(g1(1, 0) + 0.0997f) < 0.001);
        LayerNeutralInvariant(layer);
    ...
    void test_bias_layer4() {
        ...
        REQUIRE(fabs(fbOut(0, 0) + 0.0495f) < 0.001);
        REQUIRE(fabs(fbOut(1, 0) + 0.0997f) < 0.001);
    ...
    void test_bias_layer5() {
        ...
        REQUIRE(fabs(res(0, 0) - 1.27f + 0.48f) < 0.001);
        REQUIRE(fabs(res(1, 0) - 2.41f + 0.13f) < 0.001);
        ...
        REQUIRE(fabs(fbOut(0, 0) - 1.0495f) < 0.001);
        REQUIRE(fabs(fbOut(1, 0) - 2.3997f) < 0.001);
        ...
        REQUIRE(fabs(w1(0, 0) + 0.48f) < 0.001);
        REQUIRE(fabs(w1(1, 0) + 0.13f) < 0.001);
        REQUIRE(fabs(g1(0, 0) + 0.0495f - 1.0495f) < 0.001);
        REQUIRE(fabs(g1(1, 0) + 0.0997f - 2.3997f) < 0.001);
        LayerNeutralInvariant(layer);
    ...
    void test_bias_layer7() {
        ...
        for (size_t i = 0; i < val.RowNum(); ++i) {
            for (size_t j = 0; j < val.ColNum(); ++j) {
                REQUIRE(fabs(val(i, j) - 1.5) < 0.0001);
            }
        }
        cout << "done" << endl;
    }
