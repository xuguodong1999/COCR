...
namespace {
    void test_softmax_layer1() {
        ...
        REQUIRE(fabs(res(0, 0) - c(0, 0)) < 0.001);
        REQUIRE(fabs(res(0, 1) - c(0, 1)) < 0.001);
        ...
        REQUIRE(fabs(fb(0, 0) - c(0, 0)) < 0.001);
        REQUIRE(fabs(fb(0, 1) - c(0, 1)) < 0.001);
    ...
    void test_softmax_layer2() {
        ...
        for (size_t loop_count = 1; loop_count < 10; ++loop_count) {
            ...
            for (size_t i = 0; i < loop_count; ++i) {
                REQUIRE(fabs(res(0, i) - c(0, i)) < 0.0001);
            }
        }
        ...
        for (size_t loop_count = 9; loop_count >= 1; --loop_count) {
            ...
            for (size_t i = 0; i < loop_count; ++i) {
                REQUIRE(fabs(fb(0, i) - c(0, i)) < 0.0001);
            }
        }
