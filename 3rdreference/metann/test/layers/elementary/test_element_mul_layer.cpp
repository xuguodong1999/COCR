...
namespace {
    void test_element_mul_layer1() {
        ...
        REQUIRE(fabs(res(0, 0) - 0.02f) < 0.001);
        REQUIRE(fabs(res(0, 1) - 0.06f) < 0.001);
        REQUIRE(fabs(res(0, 2) - 0.12f) < 0.001);
        REQUIRE(fabs(res(1, 0) - 0.20f) < 0.001);
        REQUIRE(fabs(res(1, 1) - 0.30f) < 0.001);
        REQUIRE(fabs(res(1, 2) - 0.42f) < 0.001);
    ...
    void test_element_mul_layer2() {
        ...
        REQUIRE(fabs(g1(0, 0) - 0.06f) < 0.001);
        REQUIRE(fabs(g1(0, 1) - 0.18f) < 0.001);
        REQUIRE(fabs(g1(0, 2) - 0.36f) < 0.001);
        REQUIRE(fabs(g1(1, 0) - 0.20f) < 0.001);
        REQUIRE(fabs(g1(1, 1) - 0.06f) < 0.001);
        REQUIRE(fabs(g1(1, 2) - 0.49f) < 0.001);

        REQUIRE(fabs(g2(0, 0) - 0.03f) < 0.001);
        REQUIRE(fabs(g2(0, 1) - 0.12f) < 0.001);
        REQUIRE(fabs(g2(0, 2) - 0.27f) < 0.001);
        REQUIRE(fabs(g2(1, 0) - 0.16f) < 0.001);
        REQUIRE(fabs(g2(1, 1) - 0.05f) < 0.001);
        REQUIRE(fabs(g2(1, 2) - 0.42f) < 0.001);
    ...
    void test_element_mul_layer3() {
        ...
        for (size_t loop_count = 1; loop_count < 10; ++loop_count) {
            ...
            for (size_t i = 0; i < loop_count; ++i) {
                for (size_t j = 0; j < 3; ++j) {
                    REQUIRE(fabs(res(i, j) - i1(i, j) * i2(i, j)) < 0.0001);
                }
            }
        }
        ...
        for (size_t loop_count = 9; loop_count >= 1; --loop_count) {
            ...
            for (size_t i = 0; i < loop_count; ++i) {
                for (size_t j = 0; j < 3; ++j) {
                    REQUIRE(fabs(g1(i, j) - grad(i, j) * i2(i, j)) < 0.001);
                    REQUIRE(fabs(g2(i, j) - grad(i, j) * i1(i, j)) < 0.001);
                }
            }
        }
