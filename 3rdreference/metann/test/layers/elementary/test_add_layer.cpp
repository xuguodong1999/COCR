...
namespace {
    void test_add_layer1() {
        ...
        for (size_t i = 0; i < 2; ++i) {
            for (size_t j = 0; j < 3; ++j) {
                REQUIRE(fabs(res(i, j) - i1(i, j) - i2(i, j)) < 0.001);
            }
        }
    ...
    void test_add_layer2() {
        ...
        REQUIRE(fb1.RowNum() == fb2.RowNum());
        REQUIRE(fb1.ColNum() == fb2.ColNum());
        REQUIRE(fb1.RowNum() == 2);
        REQUIRE(fb1.ColNum() == 3);

        for (size_t i = 0; i < 2; ++i) {
            for (size_t j = 0; j < 3; ++j) {
                REQUIRE(fb1(i, j) == grad(i, j));
                REQUIRE(fb2(i, j) == grad(i, j));
            }
        }
    ...
    void test_add_layer3() {
        ...
        for (size_t i = 0; i < 2; ++i) {
            for (size_t j = 0; j < 3; ++j) {
                REQUIRE(fabs(res(i, j) - i3(i, j) - i4(i, j)) < 0.001);
            }
        }
