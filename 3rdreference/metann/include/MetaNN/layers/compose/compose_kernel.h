...
/// ========= Sublayer check ===================================================
        template<typename TSublayerCont>
        struct SublayerCheck;
...
/// ========= Internal Connection Check ===============================================
        template<typename TInternalCont>
...
/// ========= Internal Tag Should In Sublayer ==========================================
        template<typename TInternalArray, typename TSubLayerArray>
...
/// ========= Input Tag Should In Sublayer =============================================
        template<typename TInputArray, typename TSublayerArray>
...
/// ========= Output Tag Should In Sublayer ============================================
        template<typename TOutputArray, typename TSublayerArray>
...
/// ========= Internal Post Layers Should Be Useful ==================================
        template<typename TInterArray, typename TOutArray>
...
/// ========= Input Layers Should Be Useful ============================================
        template<typename TInArray, typename TInterArray, typename TOutArray>
...
/// ========= Sublayer Instantiation ===================================================
        namespace NSSI {
            template<typename TPolicyCont, typename TOrderedSublayerCont>
...
/// ========== Asserts =================================================
    ...
    static_assert((NSComposeKernel::InternalConnectCheck<InterConnects>::NoSelfCycle),
                  "Internal connections have self-connect.");
    static_assert((NSComposeKernel::InternalConnectCheck<InterConnects>::UniqueSource),
                  "One internal input corresponds to two or more internal outputs.");
    static_assert((NSComposeKernel::InputConnectCheck<InputConnects>::UniqueSource),
                  "One input corresponds to two or more sources.");
    static_assert((NSComposeKernel::OutputConnectCheck<OutputConnects>::UniqueSource),
                  "One output corresponds to two or more sources.");
    static_assert((NSComposeKernel::InternalTagInSublayer<InterConnects, SubLayers>::value),
                  "Internal connections have tags are not sublayer tags.");
    static_assert((NSComposeKernel::InputTagInSubLayer<InputConnects, SubLayers>::value),
                  "One or more input tags are not sublayer tags.");
    static_assert((NSComposeKernel::OutputTagInSubLayer<OutputConnects, SubLayers>::value),
    ...
    static_assert((NSComposeKernel::UsefulInternalPostLayer<InterConnects, OutputConnects>::value),
                  "Internal output info is useless");
    static_assert((NSComposeKernel::UsefulInputLayer<InputConnects, InterConnects, OutputConnects>::value),
