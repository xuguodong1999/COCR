...
namespace MetaNN {
    ...
    public:
        UnaryOp(TData data)
                : OperOrganizer<TOpTag, Cate>(data), m_data(std::move(data)) {}
    ...
    public:
        BinaryOp(TData1 data1, TData2 data2)
                : OperOrganizer<TOpTag, Cate>(data1, data2), m_data1(std::move(data1)), m_data2(std::move(data2)) {}
    ...
    public:
        TernaryOp(TData1 data1, TData2 data2, TData3 data3)
                : OperOrganizer<TOpTag, Cate>(data1, data2, data3), m_data1(std::move(data1)),
                  m_data2(std::move(data2)), m_data3(std::move(data3)) {}
