...
template<typename TData>
constexpr bool IsBatchMatrix<Duplicate < TData>>
=
IsMatrix<TData>;

template<typename TData>
constexpr bool IsBatchScalar<Duplicate < TData>>
=
IsScalar<TData>;
...
namespace NSDuplicate {
    ...
    public:
        EvalUnit(TInHandle oper, size_t batchNum,
                ...
                : m_oper(std::move(oper)), m_batchNum(batchNum), m_evalOutput(std::move(evalOutput)) {}
