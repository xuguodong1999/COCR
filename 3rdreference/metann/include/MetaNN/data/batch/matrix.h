...
namespace MetaNN {
    ...
    public:
        Batch(size_t p_batchNum = 0, size_t p_rowNum = 0, size_t p_colNum = 0)
                : m_mem(p_rowNum * p_colNum * p_batchNum), m_rowNum(p_rowNum), m_colNum(p_colNum),
                  m_batchNum(p_batchNum), m_rowLen(p_colNum), m_rawMatrixSize(p_rowNum * p_colNum) {}
    ...
    private:
        Batch(std::shared_ptr<ElementType> p_mem,
              ...
              size_t p_rowLen,
              size_t p_matrixSize)
                : m_mem(p_mem, p_memStart), m_rowNum(p_rowNum), m_colNum(p_colNum), m_batchNum(p_batchNum),
                  m_rowLen(p_rowLen), m_rawMatrixSize(p_matrixSize) {}
