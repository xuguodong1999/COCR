...
namespace MetaNN {
    ...
    public:
        Matrix(size_t p_rowNum = 0, size_t p_colNum = 0)
                : m_mem(p_rowNum * p_colNum), m_rowNum(p_rowNum), m_colNum(p_colNum), m_rowLen(p_colNum) {}
    ...
    private:
        Matrix(std::shared_ptr<ElementType> p_mem,
               ...
               size_t p_colNum,
               size_t p_rowLen)
                : m_mem(p_mem, p_memStart), m_rowNum(p_rowNum), m_colNum(p_colNum), m_rowLen(p_rowLen) {}
