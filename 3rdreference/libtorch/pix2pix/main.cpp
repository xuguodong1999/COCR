...
void
test(po::variables_map &vm, torch::Device &device, UNet_Generator &gen, std::vector<transforms_Compose > &transformI,
...
po::options_description parse_arguments() {
    ...
    args.add_options()
            ...
            ("train_out_dir", po::value<std::string>()->default_value("trainO"),
             "training output image directory : ./datasets/<dataset>/<train_out_dir>/<image files>")
            ...
            ("valid_out_dir", po::value<std::string>()->default_value("validO"),
             "validation output image directory : ./datasets/<dataset>/<valid_out_dir>/<image files>")
