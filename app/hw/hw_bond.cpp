...
std::shared_ptr<HwBond> HwBond::GetHwBond(const xgd::BondType &_bondType) {
    switch (_bondType) {
        case xgd::BondType::UpBond:
            return std::make_shared<HwSolidWedgeBond>();
        case xgd::BondType::DownBond:
            return std::make_shared<HwDashWedgeBond>();
        case xgd::BondType::ImplicitBond:
            return std::make_shared<HwWaveBond>();
        case xgd::BondType::SingleBond :
//        case xgd::BondType::DelocalizedBond:// 离域键只画骨架，环另画
            return std::make_shared<HwSingleBond>();
        case xgd::BondType::DoubleBond:
            return std::make_shared<HwDoubleBond>();
        case xgd::BondType::TripleBond:
            return std::make_shared<HwTripleBond>();
//        case xgd::BondType::DelocalizedBond:
