...
#define COL(R, G, B) ( 0x800 | (((R)&0x1F)<<10) | (((G)&0x1F)<<5) | ((B)&0x1F) );
        ...
        switch (atomicnum) {
            case 1:
                return COL(0x1F, 0x1F, 0x1F); // H, WHITE
            case 6:
                return COL(0x04, 0x04, 0x04); // C, (almost) BLACK
            case 7:
                return COL(0x12, 0x1A, 0x1F);  // N, SKY BLUE
            case 8:
                return COL(0x1F, 0x00, 0x00);  // O, RED
            case 16:
                return COL(0x1F, 0x1F, 0x00);  // S, YELLOW
            case 15:
                return COL(0x1F, 0x00, 0x1F);  // P, PURPLE
            case 9:
                return COL(0x00, 0x1F, 0x00);  //F, LIGHT GREEN
            case 17:
                return COL(0x00, 0x17, 0x00);  //Cl, MEDIUM GREEN
            case 35:
                return COL(0x00, 0x0F, 0x00);  //Br, MEDIUM DARK GREEN
            case 53:
                return COL(0x00, 0x07, 0x00);   //I, DARK GREEN
            case 26: // Fe
            case 27: // Co
            case 28: // Ni
            case 29:
                return COL(0x18, 0x18, 0x18); // Cu, Metals Silver
            default:
