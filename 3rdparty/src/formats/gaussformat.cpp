...
namespace OpenBabel {
    ...
    public:
        ...
        virtual const char *SpecificationURL() { return "https://www.gaussian.com/"; };

        virtual const char *GetMIMEType() { return "chemical/x-gaussian-log"; };
    ...
    public:
        ...
        virtual const char *SpecificationURL() { return "https://www.gaussian.com/input/"; };

        virtual const char *GetMIMEType() { return "chemical/x-gaussian-input"; };
        ...
        if (orbitals.size() > 0) {
            ...
            if (aHOMO == bHOMO) {
                ...
                if (initialSize != symmSize || betaStart == -1) {
                    cerr << "Inconsistency: orbitals have " << initialSize << " elements while symmetries have "
                         << symmSize << endl;
                } else {
