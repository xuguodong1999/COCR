...
// graphsym.cpp
    ...
    std::vector<int> findDescriptorVector(OBMol *mol, const OBBitVec &fragment,
                                          const OBStereoUnitSet &orderedUnits,
                                          const std::vector<unsigned int> &symmetry_classes);
    ...
    struct OBStereoTypeTraits;

    template<>
    struct OBStereoTypeTraits<OBStereo::Tetrahedral> {
        enum {
    ...
    template<>
    struct OBStereoTypeTraits<OBStereo::CisTrans> {
        enum {
    ...
    struct OBStereoCenterTraits;
    template<>
    struct OBStereoCenterTraits<OBAtom> : OBStereoTypeTraits<OBStereo::Tetrahedral> {
    };
    template<>
    struct OBStereoCenterTraits<OBBond> : OBStereoTypeTraits<OBStereo::CisTrans> {
    };
