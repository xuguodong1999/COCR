...
#include "coordgenlibs/sketcherMinimizer.h" // should be removed at the end of refactoring
...
#include "coordgenlibs/sketcherMinimizerClashInteraction.h"
#include "coordgenlibs/sketcherMinimizerConstraintInteraction.h"
#include "coordgenlibs/sketcherMinimizerEZConstrainInteraction.h"
#include "coordgenlibs/sketcherMinimizerFragment.h"
#include "coordgenlibs/sketcherMinimizerMaths.h"
#include "coordgenlibs/sketcherMinimizerResidue.h"
#include "coordgenlibs/sketcherMinimizerResidueInteraction.h"
...
void CoordgenMinimizer::run() {
    ...
    for (unsigned int iterations = 0; iterations < m_maxIterations; ++iterations) {
        ...
        if (local_energy_list[iterations - ITERATION_HISTORY_SIZE] - local_energy_list[iterations] <
            MAX_NET_ENERGY_CHANGE) {
            break;
        }
    }
