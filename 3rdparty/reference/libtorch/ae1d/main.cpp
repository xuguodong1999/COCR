...
// Function Prototype
void
train(po::variables_map &vm, torch::Device &device, AutoEncoder1d &model, std::vector<transforms_Compose > &transform);
...
po::options_description parse_arguments() {
    ...
    args.add_options()
            ...
            ("loss", po::value<std::string>()->default_value("l2"),
             "l1 (mean absolute error), l2 (mean squared error), etc.")
            ...
            ("train_dir", po::value<std::string>()->default_value("train"),
             "training data directory : ./datasets/<dataset>/<train_dir>/<data files>")
            ...
            ("valid_dir", po::value<std::string>()->default_value("valid"),
             "validation data directory : ./datasets/<dataset>/<valid_dir>/<data files>")
            ...
            ("test_in_dir", po::value<std::string>()->default_value("testI"),
             "test input data directory : ./datasets/<dataset>/<test_in_dir>/<data files>")
            ("test_out_dir", po::value<std::string>()->default_value("testO"),
             "test output data directory : ./datasets/<dataset>/<test_out_dir>/<data files>")
