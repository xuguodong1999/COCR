...
namespace OpenBabel {
    ...
    bool OBForceFieldGaff::SetupCalculations() {
                    ...
                    if (parameter == nullptr) {
                        ...
                        IF_OBFF_LOGLVL_LOW {
                            snprintf(_logbuf, BUFF_SIZE,
                                     "COULD NOT FIND PARAMETERS FOR BOND %s-%s, USING DEFAULT PARAMETERS\n",
                                     a->GetType(), b->GetType());
                            OBFFLog(_logbuf);
                        }
                ...
                if (parameter == nullptr) {
                    ...
                    if (parameter == nullptr) {
                        ...
                        if (parameter == nullptr) {
                            ...
                            IF_OBFF_LOGLVL_LOW {
                                snprintf(_logbuf, BUFF_SIZE,
                                         "COULD NOT FIND PARAMETERS FOR ANGLE %s-%s-%s, USING DEFAULT PARAMETERS\n",
                ...
                if (parameter == nullptr) {
                    ...
                    if (parameter == nullptr) {
                        ...
                        if (parameter == nullptr) {
                            ...
                            IF_OBFF_LOGLVL_LOW {
                                snprintf(_logbuf, BUFF_SIZE,
                                         "COULD NOT FIND PARAMETERS FOR TORSION %s-%s-%s-%s, USING DEFAULT PARAMETERS\n",
        ...
        //
        IF_OBFF_LOGLVL_LOW OBFFLog("SETTING UP IMPROPER TORSION CALCULATIONS...\n");
        ...
        FOR_PAIRS_OF_MOL(p, _mol) {
            ...
            if (parameter_a == nullptr) { // no vdw parameter -> use hydrogen
                ...
                IF_OBFF_LOGLVL_LOW {
                    snprintf(_logbuf, BUFF_SIZE,
                             "COULD NOT FIND VDW PARAMETERS FOR ATOM %s, USING HYDROGEN VDW PARAMETERS\n",
                             a->GetType());
                    OBFFLog(_logbuf);
                }
            } else {
            ...
            if (!visited[atm->GetIdx() - 1]) {
                if (strcmp(atm->GetType(), "cc") == 0 ||
                    ...
                    FOR_BONDS_OF_ATOM(bond, atm) {
                        a = bond->GetBeginAtom();
                        b = bond->GetEndAtom();
                        if ((strcmp(a->GetType(), "cc") == 0 || strcmp(a->GetType(), "cd") == 0) &&
                            (strcmp(b->GetType(), "cc") == 0 || strcmp(b->GetType(), "cd") == 0)) {
                            BO = bond->GetBondOrder();
                            if ((BO > 1 && strcmp(a->GetType(), b->GetType()) == 0) ||
                                (BO == 1 && strcmp(a->GetType(), b->GetType()) != 0)) {
                        ...
                        if ((strcmp(a->GetType(), "ce") == 0 || strcmp(a->GetType(), "cf") == 0) &&
                            (strcmp(b->GetType(), "ce") == 0 || strcmp(b->GetType(), "cf") == 0)) {
                            BO = bond->GetBondOrder();
                            if ((BO > 1 && strcmp(a->GetType(), b->GetType()) == 0) ||
                                (BO == 1 && strcmp(a->GetType(), b->GetType()) != 0)) {
                                if (!visited[a->GetIdx() - 1]) {
                        ...
                        if ((strcmp(a->GetType(), "cp") == 0 || strcmp(a->GetType(), "cq") == 0) &&
                            (strcmp(b->GetType(), "cp") == 0 || strcmp(b->GetType(), "cq") == 0)) {
                            BO = bond->GetBondOrder();
                            if ((BO > 1 && strcmp(a->GetType(), b->GetType()) == 0) ||
                                (BO == 1 && strcmp(a->GetType(), b->GetType()) != 0)) {
                                if (!visited[a->GetIdx() - 1]) {
                        ...
                        if ((strcmp(a->GetType(), "nc") == 0 || strcmp(a->GetType(), "nd") == 0) &&
                            (strcmp(b->GetType(), "nc") == 0 || strcmp(b->GetType(), "nd") == 0)) {
                            BO = bond->GetBondOrder();
                            if ((BO > 1 && strcmp(a->GetType(), b->GetType()) == 0) ||
                                (BO == 1 && strcmp(a->GetType(), b->GetType()) != 0)) {
                                if (!visited[a->GetIdx() - 1]) {
                        ...
                        if ((strcmp(a->GetType(), "ne") == 0 || strcmp(a->GetType(), "nf") == 0) &&
                            (strcmp(b->GetType(), "ne") == 0 || strcmp(b->GetType(), "nf") == 0)) {
                            BO = bond->GetBondOrder();
                            if ((BO > 1 && strcmp(a->GetType(), b->GetType()) == 0) ||
                                (BO == 1 && strcmp(a->GetType(), b->GetType()) != 0)) {
                                if (!visited[a->GetIdx() - 1]) {
                        ...
                        if ((strcmp(a->GetType(), "pc") == 0 || strcmp(a->GetType(), "pd") == 0) &&
                            (strcmp(b->GetType(), "pc") == 0 || strcmp(b->GetType(), "pd") == 0)) {
                            BO = bond->GetBondOrder();
                            if ((BO > 1 && strcmp(a->GetType(), b->GetType()) == 0) ||
                                (BO == 1 && strcmp(a->GetType(), b->GetType()) != 0)) {
                                if (!visited[a->GetIdx() - 1]) {
                        ...
                        if ((strcmp(a->GetType(), "pe") == 0 || strcmp(a->GetType(), "pf") == 0) &&
                            (strcmp(b->GetType(), "pe") == 0 || strcmp(b->GetType(), "pf") == 0)) {
                            BO = bond->GetBondOrder();
                            if ((BO > 1 && strcmp(a->GetType(), b->GetType()) == 0) ||
                                (BO == 1 && strcmp(a->GetType(), b->GetType()) != 0)) {
                                if (!visited[a->GetIdx() - 1]) {
