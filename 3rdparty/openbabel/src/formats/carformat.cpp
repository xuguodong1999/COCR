...
namespace OpenBabel {
    ...
    public:
        ...
        virtual const char *
        SpecificationURL() { return "http://www.centrcn.umontreal.ca/accelrys/life/insight2000.1/formats980/Files980TOC.doc.html"; }; //optional

        virtual const char *GetMIMEType() { return "chemical/x-msi-car"; };
