...
#define ANGSTROM_TO_BOHR 1.889725989
    ...
    public:
        ...
        virtual const char *
        SpecificationURL() { return "http://daltonprogram.org/www/resources/dalton2016manual.pdf"; }; //optional

        virtual const char *GetMIMEType() { return "chemical/x-dalton-output"; };
    ...
    public:
        ...
        DALTONInputFormat() {
            ...
            OBConversion::RegisterOptionParam("k", nullptr, 1,
                                              OBConversion::OUTOPTIONS); // specify basis set in .mol file
        }
        ...
        virtual const char *GetMIMEType() { return "chemical/x-dalton-input"; };
