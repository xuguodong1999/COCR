...
#define ANGSTROM_TO_BOHR 1.889725989
    ...
    public:
        ...
        // Variables
        enum ReadMode_t {
            CARTESIAN, ZMATRIX, VARIABLES, CONSTANTS, SKIP
        };
        ReadMode_t ReadMode;
    ...
    bool GAMESSUKFormat::ReadGeometry(OBMol &mol, vector<string> &geomList) {
        ...
        */
        ...
        for (vector<string>::iterator i = geomList.begin(); i != geomList.end(); ++i) {
            ...
            } else if (line.compare(0, 4, "coor") == 0 || line.compare(0, 4, "cart") == 0 ||
                       line.compare(0, 4, "geom") == 0) {
                ReadMode = CARTESIAN;
    ...
    bool GAMESSUKFormat::ReadLineZmatrix(OBMol &mol, OBAtom *atom, vector<string> &tokens, double factor,
                                         int *zmatLineCount) {
        /*
    ...
    public:
        ...
        virtual const char *SpecificationURL() { return "http://www.cfs.dl.ac.uk"; }; //optional

        virtual const char *GetMIMEType() { return "chemical/x-gamessuk-input"; };
    ...
    public:
        //Register this format type ID
        GAMESSUKOutputFormat() { OBConversion::RegisterFormat("gukout", this, "chemical/x-gamess-output"); }
        ...
        virtual const char *GetMIMEType() { return "chemical/x-gamessuk-output"; };
    ...
    private:
        enum RunType_t {
            UNKNOWN, SINGLEPOINT, OPTXYZ, OPTZMAT, SADDLE, FREQUENCIES
        };
