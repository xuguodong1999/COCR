...
int str_Sp2(INCHI_SORT *pINChISort, INCHI_SORT *pINChISort2, char *pStr, int nStrLen, int tot_len,
    ...
    for (i = 0; i <= num_components; i++) {
        ...
        if (bSecondNonTautPass) {
            ...
            pINChI_Taut = (i < num_components && (is2 = is20 + i, 0 <= (ii2 = GET_II(OUT_T1, is2)))) ? is2->pINChI[ii2]
                                                                                                     : NULL;
        }
        ...
        if (eq2taut) {
            ...
            } else if (pINChI_Taut_Prev && pINChI_Taut_Prev->nNumberOfAtoms) {
            ...
            if (eq2prev) {
                ...
                if (pINChI_Prev && pINChI_Prev->nNumberOfAtoms) {
                ...
                } else if (bSecondNonTautPass && pINChI_Taut_Prev && pINChI_Taut_Prev->nNumberOfAtoms) {
                    ...
                    } else { ; /* pINChI_Taut_Prev exists and has not sp2 info */
                    }
                }
            ...
            if (eq2prev) {
                ...
                if (pINChI_Prev && pINChI_Prev->nNumberOfAtoms) {
                    ...
                    if ((Stereo_Taut_Prev = pINChI_Taut_Prev->Stereo) &&
                        Stereo_Taut_Prev->nNumberOfStereoCenters > bRelRac) {
                        /* since pINChI_Prev does not exist, pINChI_Taut_Prev is non-tautomeric */
                    ...
                    } else { ; /* pINChI_Taut_Prev exists and has not sp3 info */
                    }
                }
#if (bRELEASE_VERSION != 1 && defined(_DEBUG))
                                                                                                                                        else {
        ...
        if (eq2taut) {
            ...
            if (pINChI_Prev && pINChI_Prev->nNumberOfAtoms) {
                ...
                if (pINChI_Prev && (pINChI_Prev->nNumberOfIsotopicAtoms > 0 ||
                    ...
                    tot_len += MakeMult(mult + 1, "*", pStr + tot_len, nStrLen - tot_len, 0, bOverflow);
                    /*  Isotopic atoms */
                    if (pINChI_Prev->nNumberOfIsotopicAtoms > 0 && nStrLen - tot_len > 2 &&
                        !*bOverflow) { /* dereferenced bOverflow 2004-06-07 */
                    ...
                    if (pINChI_Prev->nNumberOfIsotopicTGroups > 0 && nStrLen - tot_len > 3 && !*bOverflow) {
                        tot_len += MakeDelim(bAbcNumbers ? ITEM_DELIMETER : "(", pStr + tot_len, nStrLen - tot_len,
                                             bOverflow);
                ...
                if (pINChI_Prev && pINChI_Prev->nNumberOfAtoms) {
                    if ((pINChI_Prev->nNumberOfIsotopicAtoms > 0 ||
                        ...
                        if (pINChI_Prev->nNumberOfIsotopicTGroups > 0 && nStrLen - tot_len > 3 && !*bOverflow) {
                            tot_len += MakeDelim(bAbcNumbers ? ITEM_DELIMETER : "(", pStr + tot_len, nStrLen - tot_len,
                                                 bOverflow);
                            tot_len += MakeIsoTautString(pINChI_Prev->IsotopicTGroup,
                                                         pINChI_Prev->nNumberOfIsotopicTGroups,
                                                         pStr + tot_len, nStrLen - tot_len, TAUT_MODE, bOverflow);
                            if (!bAbcNumbers) {
                                tot_len += MakeDelim(")", pStr + tot_len, nStrLen - tot_len, bOverflow);
                            }
                    ...
                    } else { ; /* pINChI_Taut_Prev exists and has not isotopic info */
                    }
                }
#if (bRELEASE_VERSION != 1 && defined(_DEBUG))
                                                                                                                                        else {
            ...
            if (eq2prev) {
                ...
                if (bSecondNonTautPass && pINChI_Taut_Prev && pINChI_Taut_Prev->nNumberOfAtoms) {
                    if ((Stereo_Taut_Prev = pINChI_Taut_Prev->StereoIsotopic) &&
                        Stereo_Taut_Prev->nNumberOfStereoBonds > 0) {
                        /* since pINChI_Prev does not exist, pINChI_Taut_Prev is non-tautomeric */
                        /* and it has non-trivial sp2 info */
                        /*
                        tot_len += MakeDelim( sIdenticalValues, pStr + tot_len, nStrLen-tot_len, bOverflow);
...
int str_AuxEqu(INCHI_SORT *pINChISort, INCHI_SORT *pINChISort2, char *pStr, int nStrLen, int tot_len,
    ...
    for (i = 0; i <= num_components; i++) {
        /* 1st (taut) pass: bOutType=OUT_TN  ; 2nd (non-taut pass) bOutType=OUT_NT */
        pINChI_Aux = (i < num_components && (is = is0 + i, 0 <= (ii = GET_II(bOutType, is)))) ? is->pINChI_Aux[ii]
                                                                                              : NULL;
        if (bSecondNonTautPass) {
            /* component that was output on the 1st pass */
            pINChI_Aux_Taut = (i < num_components && (is2 = is20 + i, 0 <= (ii2 = GET_II(OUT_T1, is2))))
                              ? is2->pINChI_Aux[ii2] : NULL;
        }
            ...
            if (pINChI_Aux_Prev && pINChI_Aux_Prev->nNumberOfAtoms) {
                ...
                if (bHasEquString(pINChI_Aux_Prev->nConstitEquNumbers, pINChI_Aux_Prev->nNumberOfAtoms)) {
                    ...
                    tot_len += MakeEquString(pINChI_Aux_Prev->nConstitEquNumbers, pINChI_Aux_Prev->nNumberOfAtoms, 0,
                                             pStr + tot_len, nStrLen - tot_len, TAUT_MODE, bOverflow);
                } else { ; /* pINChI_Aux_Prev exists and has only trivial equivalence info */
                }
            } else if (pINChI_Aux_Taut_Prev && pINChI_Aux_Taut_Prev->nNumberOfAtoms) {
                /* previous non-taut component exists only in taut list */
                if (bNext++) {
                    tot_len += MakeDelim(sCompDelim, pStr + tot_len, nStrLen - tot_len, bOverflow);
                }
            ...
            if (eq2prev) {
                ...
                if (pINChI_Aux_Prev && pINChI_Aux_Prev->nNumberOfAtoms) {
                    if (bHasEquString(pINChI_Aux_Prev->nConstitEquNumbers, pINChI_Aux_Prev->nNumberOfAtoms)) {
                        ...
                        tot_len += MakeMult(mult + 1, "*", pStr + tot_len, nStrLen - tot_len, 0, bOverflow);
                        tot_len += MakeEquString(pINChI_Aux_Prev->nConstitEquNumbers, pINChI_Aux_Prev->nNumberOfAtoms,
                                                 0,
                                                 pStr + tot_len, nStrLen - tot_len, TAUT_MODE, bOverflow);
                    } else { ; /* pINChI_Aux_Prev exists and has only trivial equivalence info */
                    }
                } else if (bSecondNonTautPass && pINChI_Aux_Taut_Prev && pINChI_Aux_Taut_Prev->nNumberOfAtoms) {
                    if (bHasEquString(pINChI_Aux_Taut_Prev->nConstitEquNumbers, pINChI_Aux_Taut_Prev->nNumberOfAtoms)) {
                        ...
                        tot_len += MakeDelim( sIdenticalValues, pStr + tot_len, nStrLen-tot_len, bOverflow);
                        */
                    } else { ; /* pINChI_Aux_Taut_Prev exists and has only trivial equivalence info */
                    }
                }
#if (bRELEASE_VERSION != 1 && defined(_DEBUG))
                                                                                                                                        else {
...
int str_AuxIsoEqu(INCHI_SORT *pINChISort, INCHI_SORT *pINChISort2, char *pStr, int nStrLen, int tot_len,
    ...
    for (i = 0; i <= num_components; i++) {
        ...
        } else if (!bSecondNonTautPass && bOmitRepetitions && pINChI_Aux && pINChI_Aux->bIsIsotopic) {
            /**************************************************
        ...
        if (eq2taut) {
            ...
            if (pINChI_Aux_Prev && pINChI_Aux_Prev->nNumberOfAtoms) {
                ...
                if (bHasEquString(pINChI_Aux_Prev->nConstitEquIsotopicNumbers, pINChI_Aux_Prev->nNumberOfAtoms)) {
                    /* output previous component(s) equivalence since it was found to be non-trivial */
                    tot_len += MakeMult(mult + 1, "*", pStr + tot_len, nStrLen - tot_len, 0, bOverflow);
                    tot_len += MakeEquString(pINChI_Aux_Prev->nConstitEquIsotopicNumbers,
                                             pINChI_Aux_Prev->nNumberOfAtoms, 0,
                                             pStr + tot_len, nStrLen - tot_len, TAUT_MODE, bOverflow);
                } else { ; /* pINChI_Aux_Prev exists and has only trivial equivalence info */
                }
            } else if (pINChI_Aux_Taut_Prev && pINChI_Aux_Taut_Prev->nNumberOfAtoms) {
            ...
            if (eq2prev) {
                ...
                if (pINChI_Aux_Prev && pINChI_Aux_Prev->nNumberOfAtoms) {
                    ...
                    if (bHasEquString(pINChI_Aux_Taut_Prev->nConstitEquIsotopicNumbers,
                                      pINChI_Aux_Taut_Prev->nNumberOfAtoms)) {
                        /* since pINChI_Aux_Prev does not exist, pINChI_Aux_Taut_Prev is non-tautomeric */
                        /* and it has non-trivial equivalence info. This info has already been printed in the main section  */
                        /*
                        tot_len += MakeDelim( sIdenticalValues, pStr + tot_len, nStrLen-tot_len, bOverflow);
    ...
    *********************************/
    ...
    for (i = 0; i <= num_components; i++) {
        ...
        if (bSecondNonTautPass && bOmitRepetitions && pINChI &&
            pINChI->nNumberOfIsotopicAtoms + pINChI->nNumberOfIsotopicTGroups > 0) {
        ...
        if (eq2taut) {
            ...
            if (eq2prev) {
                ...
                if (pINChI_Prev && pINChI_Prev->nNumberOfAtoms &&
                    pINChI_Prev->nNumberOfIsotopicAtoms + pINChI_Prev->nNumberOfIsotopicTGroups > 0) {
        ...
        if (bSecondNonTautPass && bOmitRepetitions && pINChI && pINChI_Aux && pINChI_Aux->bIsIsotopic &&
            ...
            if (!eq2taut) {
                eq2taut = pINChI_Taut &&
                          ...
                          Eql_INChI_Aux_Num(pINChI_Aux, EQL_NUM_INV | EQL_NUM_ISO, pINChI_Aux_Taut,
                                            EQL_NUM_INV | EQL_NUM_ISO);
...
int str_Charge2(INCHI_SORT *pINChISort, INCHI_SORT *pINChISort2, char *pStr, int nStrLen, int tot_len,
    ...
    for (i = 0; i <= num_components; i++) {
        ...
        if (eq2taut) {
            ...
            } else if (pINChI_Taut_Prev && pINChI_Taut_Prev->nNumberOfAtoms && !pINChI_Taut_Prev->bDeleted) {
                /* previous non-taut component exists only in taut list */
                if (bNext++) {
                    tot_len += MakeDelim(sCompDelim, pStr + tot_len, nStrLen - tot_len, bOverflow);
                }
    ...
    for (i++; i <= num_components; i++) {
        ...
        if (eq2prev) {
            ...
            if (pINChI_Aux_Prev && pINChI_Aux_Prev->nNumberOfTGroups &&
                ...
                tot_len += MakeMult(mult + 1, "*", pStr + tot_len, nStrLen - tot_len, 0, bOverflow);
                tot_len += MakeEquString(pINChI_Aux_Prev->nConstitEquTGroupNumbers, pINChI_Aux_Prev->nNumberOfTGroups,
                                         0,
                                         pStr + tot_len, nStrLen - tot_len, TAUT_MODE, bOverflow);
            }
        }
            ...
            if (pINChI_Aux_Prev && pINChI_Aux_Prev->nNumberOfAtoms) {
                if (bHasOrigInfo(pINChI_Aux_Prev->OrigInfo, pINChI_Aux_Prev->nNumberOfAtoms)) {
                    ...
                    tot_len += MakeCRVString(pINChI_Aux_Prev->OrigInfo, pINChI_Aux_Prev->nNumberOfAtoms, 0,
                                             pStr + tot_len, nStrLen - tot_len, TAUT_MODE, bOverflow);
                } else { ; /* pINChI_Aux_Prev exists and has only trivial info */
                }
            }
#if (bRELEASE_VERSION != 1 && defined(_DEBUG))
                                                                                                                                    else {
...
int str_AuxIsoTgroupEqu(INCHI_SORT *pINChISort, char *pStr, int nStrLen, int tot_len,
                        int *bOverflow, int bOutType, int TAUT_MODE, int num_components, int bOmitRepetitions,
                        int bUseMulipliers) {
    int i, ii;
    INCHI_SORT *is, *is0;
    INChI_Aux *pINChI_Aux, *pINChI_Aux_Prev;
    ...
    for (i = 0; i <= num_components; i++) {
        ...
        if (eq2taut) {
            ...
            if (pINChI_Aux_Prev && pINChI_Aux_Prev->nNumberOfAtoms) {
                ...
                if (bHasEquString(pINChI_Aux_Prev->nConstitEquIsotopicTGroupNumbers,
                                  pINChI_Aux_Prev->nNumberOfTGroups)) {
                    /* output previous component(s) equivalence since it was found to be non-trivial */
                    tot_len += MakeMult(mult + 1, "*", pStr + tot_len, nStrLen - tot_len, 0, bOverflow);
                    tot_len += MakeEquString(pINChI_Aux_Prev->nConstitEquIsotopicTGroupNumbers,
                                             pINChI_Aux_Prev->nNumberOfTGroups, 0,
                                             pStr + tot_len, nStrLen - tot_len, TAUT_MODE, bOverflow);
                } else { ; /* pINChI_Aux_Prev exists and does not have non-trivial t-group equivalence info */
                }
            }
            ...
            eq2prev = bUseMulipliers && Eql_INChI_Aux_Equ(pINChI_Aux, EQL_EQU_TG | EQL_EQU_ISO, pINChI_Aux_Prev,
                                                          EQL_EQU_TG | EQL_EQU_ISO);
            if (eq2prev) {
                /* eq. info is same and non-trivial */
                mult++; /* mult = (number of non-empty equal items)-1 */
                continue;
