...
namespace OpenBabel {
    ...
    public:
        ...
        virtual const char *SpecificationURL() { return "http://crk.sourceforge.net/"; }; //optional

        virtual const char *GetMIMEType() { return "chemical/x-crk2d"; };
    ...
    public:
        ...
        virtual const char *GetMIMEType() { return "chemical/x-crk3d"; };
