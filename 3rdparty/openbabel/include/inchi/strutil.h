...
int Create_INChI(INChI **ppINChI,
...
int FillOutInfAtom(inp_ATOM *norm_at,
                   INF_ATOM_DATA *inf_norm_at_data,
                   int init_num_at,
                   int num_removed_H, int bAdd_DT_to_num_H,
...
int FillOutCompositeCanonInfAtom(COMP_ATOM_DATA *composite_norm_data,
                                 INF_ATOM_DATA *inf_norm_at_data,
...
int WriteOrigAtomDataToSDfile(const ORIG_ATOM_DATA *inp_at_data, INCHI_IOSTREAM *fcb, const char *name,
                              const char *comment, int bChiral, int bAtomsDT, const char *szLabel, const char *szValue);
