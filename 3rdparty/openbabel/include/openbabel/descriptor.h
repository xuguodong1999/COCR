...
// Class introduction in descriptor.cpp
    ...
    public:
        ...
        virtual double Predict(OBBase * /* pOb */,
                               std::string * /* param */ = nullptr) { return std::numeric_limits<double>::quiet_NaN(); }
    ...
    protected:
        ...
        static bool
        CompareStringWithFilter(std::istream &optionText, std::string &s, bool noEval, bool NoCompOK = false);
