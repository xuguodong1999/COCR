...
namespace OpenBabel {
    ...
    public:
         ...
         * indexes start from 1 (i.e. OBAtom::GetIdx()).
         */
        virtual void MapAll(const OBMol *queried, Mappings &maps, const OBBitVec &mask = OBBitVec(),
                            std::size_t maxMemory = 3000000) = 0;
     ...
     * @since version 2.3
     */
    OBAPI bool FindAutomorphisms(OBMol *mol, std::vector<OBIsomorphismMapper::Mapping> &aut,
     ...
     */
    OBAPI bool
    FindAutomorphisms(OBMol *mol, std::vector<OBIsomorphismMapper::Mapping> &aut, const OBBitVec &mask = OBBitVec(),
