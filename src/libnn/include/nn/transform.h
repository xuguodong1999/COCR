...
class ELS_NN_EXPORT RandomHorizontalFlip : public torch::data::transforms::TensorTransform<torch::Tensor> {
public:
...
class ELS_NN_EXPORT ConstantPad : public torch::data::transforms::TensorTransform<torch::Tensor> {
public:
...
class ELS_NN_EXPORT RandomCrop : public torch::data::transforms::TensorTransform<torch::Tensor> {
public:
