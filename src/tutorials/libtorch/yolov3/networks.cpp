...
YOLOv3Impl::YOLOv3Impl(po::variables_map &vm) {
    ...
    this->stage1->push_back(
            ConvBlockImpl(/*in_nc=*/nc, /*out_nc=*/32, /*ksize=*/3, /*stride=*/1, /*pad=*/1, /*BN=*/true, /*LReLU=*/
                                    true));                  // {C,608,608} ===> {32,608,608}
    this->stage1->push_back(
            ConvBlockImpl(/*in_nc=*/32, /*out_nc=*/64, /*ksize=*/3, /*stride=*/2, /*pad=*/1, /*BN=*/true, /*LReLU=*/
                                    true));                  // {32,608,608} ===> {64,304,304}

    // 2nd Layers  {64,304,304} ===> {128,152,152}
    this->stage1->push_back(ResBlockImpl(64,
                                         32));                                                                                                           // {64,304,304} ===> {32,304,304} ===> {64,304,304}
    this->stage1->push_back(
            ConvBlockImpl(/*in_nc=*/64, /*out_nc=*/128, /*ksize=*/3, /*stride=*/2, /*pad=*/1, /*BN=*/true, /*LReLU=*/
                                    true));                 // {64,304,304} ===> {128,152,152}

    // 3rd Layers  {128,152,152} ===> {256,76,76}
    this->stage1->push_back(ResBlockImpl(128,
                                         64));                                                                                                          // {128,152,152} ===> {64,152,152} ===> {128,152,152}
    this->stage1->push_back(ResBlockImpl(128,
                                         64));                                                                                                          // {128,152,152} ===> {64,152,152} ===> {128,152,152}
    this->stage1->push_back(
            ConvBlockImpl(/*in_nc=*/128, /*out_nc=*/256, /*ksize=*/3, /*stride=*/2, /*pad=*/1, /*BN=*/true, /*LReLU=*/
                                    true));                // {128,152,152} ===> {256,76,76}
    for (size_t i = 0; i < 8; i++) {
        this->stage1->push_back(ResBlockImpl(256,
                                             128));                                                                                                     // {256,76,76} ===> {128,76,76} ===> {256,76,76}
    }
    ...
    this->stage2->push_back(
            ConvBlockImpl(/*in_nc=*/256, /*out_nc=*/512, /*ksize=*/3, /*stride=*/2, /*pad=*/1, /*BN=*/true, /*LReLU=*/
                                    true));                // {256,76,76} ===> {512,38,38}
    for (size_t i = 0; i < 8; i++) {
        this->stage2->push_back(ResBlockImpl(512,
                                             256));                                                                                                     // {512,38,38} ===> {256,38,38} ===> {512,38,38}
    }
    ...
    this->stage3->push_back(
            ConvBlockImpl(/*in_nc=*/512, /*out_nc=*/1024, /*ksize=*/3, /*stride=*/2, /*pad=*/1, /*BN=*/true, /*LReLU=*/
                                    true));               // {512,38,38} ===> {1024,19,19}
    for (size_t i = 0; i < 4; i++) {
        this->stage3->push_back(ResBlockImpl(1024,
                                             512));                                                                                                    // {1024,19,19} ===> {512,19,19} ===> {1024,19,19}
    }
    this->stage3->push_back(
            ConvBlockImpl(/*in_nc=*/1024, /*out_nc=*/512, /*ksize=*/1, /*stride=*/1, /*pad=*/0, /*BN=*/true, /*LReLU=*/
                                    true));               // {1024,19,19} ===> {512,19,19}
    this->stage3->push_back(
            ConvBlockImpl(/*in_nc=*/512, /*out_nc=*/1024, /*ksize=*/3, /*stride=*/1, /*pad=*/1, /*BN=*/true, /*LReLU=*/
                                    true));               // {512,19,19} ===> {1024,19,19}
    this->stage3->push_back(
            ConvBlockImpl(/*in_nc=*/1024, /*out_nc=*/512, /*ksize=*/1, /*stride=*/1, /*pad=*/0, /*BN=*/true, /*LReLU=*/
                                    true));               // {1024,19,19} ===> {512,19,19}
    this->stage3->push_back(
    ...
    this->stage4->push_back(
            ConvBlockImpl(/*in_nc=*/512, /*out_nc=*/256, /*ksize=*/1, /*stride=*/1, /*pad=*/0, /*BN=*/true, /*LReLU=*/
                                    true));                // {512,19,19} ===> {256,19,19}
    ...
    this->stage5->push_back(
            ConvBlockImpl(/*in_nc=*/512 + 256, /*out_nc=*/256, /*ksize=*/1, /*stride=*/1, /*pad=*/0, /*BN=*/
                                    true, /*LReLU=*/true));            // {512+256,38,38} ===> {256,38,38}
    this->stage5->push_back(
            ConvBlockImpl(/*in_nc=*/256, /*out_nc=*/512, /*ksize=*/3, /*stride=*/1, /*pad=*/1, /*BN=*/true, /*LReLU=*/
                                    true));                // {256,38,38} ===> {512,38,38}
    this->stage5->push_back(
            ConvBlockImpl(/*in_nc=*/512, /*out_nc=*/256, /*ksize=*/1, /*stride=*/1, /*pad=*/0, /*BN=*/true, /*LReLU=*/
                                    true));                // {512,38,38} ===> {256,38,38}
    this->stage5->push_back(
            ConvBlockImpl(/*in_nc=*/256, /*out_nc=*/512, /*ksize=*/3, /*stride=*/1, /*pad=*/1, /*BN=*/true, /*LReLU=*/
                                    true));                // {256,38,38} ===> {512,38,38}
    this->stage5->push_back(
    ...
    this->stage6->push_back(
            ConvBlockImpl(/*in_nc=*/256, /*out_nc=*/128, /*ksize=*/1, /*stride=*/1, /*pad=*/0, /*BN=*/true, /*LReLU=*/
                                    true));                // {256,38,38} ===> {128,38,38}
    ...
    this->stageA->push_back(
            ConvBlockImpl(/*in_nc=*/512, /*out_nc=*/1024, /*ksize=*/3, /*stride=*/1, /*pad=*/1, /*BN=*/true, /*LReLU=*/
                                    true));               // {512,19,19} ===> {1024,19,19}
    this->stageA->push_back(
            ConvBlockImpl(/*in_nc=*/1024, /*out_nc=*/final_features, /*ksize=*/1, /*stride=*/1, /*pad=*/0, /*BN=*/
                                    false, /*LReLU=*/false));  // {1024,19,19} ===> {A*(CN+5),19,19}
    ...
    this->stageB->push_back(
            ConvBlockImpl(/*in_nc=*/256, /*out_nc=*/512, /*ksize=*/3, /*stride=*/1, /*pad=*/1, /*BN=*/true, /*LReLU=*/
                                    true));                // {256,38,38} ===> {512,38,38}
    this->stageB->push_back(
            ConvBlockImpl(/*in_nc=*/512, /*out_nc=*/final_features, /*ksize=*/1, /*stride=*/1, /*pad=*/0, /*BN=*/
                                    false, /*LReLU=*/false));   // {512,38,38} ===> {A*(CN+5),38,38}
    ...
    this->stageC->push_back(
            ConvBlockImpl(/*in_nc=*/256 + 128, /*out_nc=*/128, /*ksize=*/1, /*stride=*/1, /*pad=*/0, /*BN=*/
                                    true, /*LReLU=*/true));            // {256+128,76,76} ===> {128,76,76}
    this->stageC->push_back(
            ConvBlockImpl(/*in_nc=*/128, /*out_nc=*/256, /*ksize=*/3, /*stride=*/1, /*pad=*/1, /*BN=*/true, /*LReLU=*/
                                    true));                // {128,76,76} ===> {256,76,76}
    this->stageC->push_back(
            ConvBlockImpl(/*in_nc=*/256, /*out_nc=*/128, /*ksize=*/1, /*stride=*/1, /*pad=*/0, /*BN=*/true, /*LReLU=*/
                                    true));                // {256,76,76} ===> {128,76,76}
    this->stageC->push_back(
            ConvBlockImpl(/*in_nc=*/128, /*out_nc=*/256, /*ksize=*/3, /*stride=*/1, /*pad=*/1, /*BN=*/true, /*LReLU=*/
                                    true));                // {128,76,76} ===> {256,76,76}
    this->stageC->push_back(
    ...
    this->stageC->push_back(
            ConvBlockImpl(/*in_nc=*/128, /*out_nc=*/256, /*ksize=*/3, /*stride=*/1, /*pad=*/1, /*BN=*/true, /*LReLU=*/
                                    true));                // {128,76,76} ===> {256,76,76}
    this->stageC->push_back(
            ConvBlockImpl(/*in_nc=*/256, /*out_nc=*/final_features, /*ksize=*/1, /*stride=*/1, /*pad=*/0, /*BN=*/
                                    false, /*LReLU=*/false));   // {256,76,76} ===> {A*(CN+5),76,76}
...
std::vector<torch::Tensor> YOLOv3Impl::forward(torch::Tensor x) {
    ...
    outA = outA.permute(
            {0, 2, 3, 1}).contiguous();                                 // {A*(CN+5),19,19} ===> {19,19,A*(CN+5)}
    out.push_back(outA);

    outB = this->stageB->forward(feature5);                                         // {256,38,38} ===> {A*(CN+5),38,38}
    outB = outB.permute(
            {0, 2, 3, 1}).contiguous();                                 // {A*(CN+5),38,38} ===> {38,38,A*(CN+5)}
    out.push_back(outB);

    outC = this->stageC->forward(
            torch::cat({feature1, feature6}, /*dim=*/1));      // {256+128,76,76} ===> {A*(CN+5),76,76}
    outC = outC.permute(
            {0, 2, 3, 1}).contiguous();                                 // {A*(CN+5),76,76} ===> {76,76,A*(CN+5)}
    out.push_back(outC);
...
ResBlockImpl::ResBlockImpl(const size_t outside_nc, const size_t inside_nc) {
    this->sq->push_back(
            ConvBlockImpl(/*in_nc=*/outside_nc, /*out_nc=*/inside_nc, /*ksize=*/1, /*stride=*/1, /*pad=*/0, /*BN=*/
                                    true, /*LReLU=*/true));
    this->sq->push_back(
            ConvBlockImpl(/*in_nc=*/inside_nc, /*out_nc=*/outside_nc, /*ksize=*/3, /*stride=*/1, /*pad=*/1, /*BN=*/
                                    true, /*LReLU=*/true));
...
// ---------------------------------------------------------
ConvBlockImpl::ConvBlockImpl(const size_t in_nc, const size_t out_nc, const size_t ksize, const size_t stride,
