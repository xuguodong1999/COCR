...
// ------------------------------------
YOLODetector::YOLODetector(const std::vector<std::tuple<float, float>> anchors_, const long int class_num_,
    ...
    this->anchors_wh = torch::from_blob(anchors.data(), {1, 1, this->na, 2},
                                        torch::kFloat).clone();  // anchors_wh{1,1,A,2}
}
