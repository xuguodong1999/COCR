...
// Function Prototype
void train(po::variables_map &vm, torch::Device &device, MC_AlexNet &model, std::vector<transforms_Compose > &transform,
           const std::vector<std::string> class_names);

void test(po::variables_map &vm, torch::Device &device, MC_AlexNet &model, std::vector<transforms_Compose > &transform,
          const std::vector<std::string> class_names);
