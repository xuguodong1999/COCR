...
class OB_EXPORT OBFingerprint : public OBPlugin
{
...
struct OB_EXPORT FptIndexHeader
{
...
class OB_EXPORT FastSearchIndexer
{
//see end of cpp file for detailed documentation
public:
