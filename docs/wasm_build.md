...
emcmake cmake .. -G "Ninja" -DQt5_DIR:PATH=~/shared/Qt/5.15.2/wasm_32/lib/cmake/Qt5 -DWASM=ON -DBUILD_SHARED_LIBS=OFF  -Wno-dev
```
...
emcmake cmake .. -G "Ninja" -DQt5_DIR:PATH=C:/Qt/5.15.2/wasm_32/lib/cmake/Qt5 -DWASM=ON -DBUILD_SHARED_LIBS=OFF -Wno-dev
```
