...
class VGG(nn.Module):
    ...
    def __init__(self, input_channel, output_channel=512, depthwise=False):
        ...
        self.ConvNet = nn.Sequential(
            ...
            nn.Conv2d(self.output_channel[1], self.output_channel[2], 3, 1, 1,
                      groups=1 if not depthwise else self.output_channel[1]
            ...
            nn.Conv2d(self.output_channel[3], self.output_channel[3], 3, 1, 1, bias=False,
                      groups=1 if not depthwise else self.output_channel[3]
                      ),
