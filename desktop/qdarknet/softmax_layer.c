...
contrastive_layer make_contrastive_layer(int batch, int w, int h, int c, int classes, int inputs, layer *yolo_layer) {
    ...
    fprintf(stderr, "contrastive %4d x%4d x%4d x emb_size %4d x batch: %4d  classes = %4d, step = %4d \n", w, h, l.n,
            l.embedding_size, batch, classes, step);
                                ...
                                for (w2 = 0; w2 < l.w; ++w2) {
                                    ...
                                    if (l.detection) {
                                        P = P_constrastive_f(z_index, z_index2, l.labels, z, l.embedding_size,
                                                             l.temperature, contrast_p, contrast_p_index);
                                    } else {
            ...
            for (h = 0; h < l.h; ++h) {
                for (w = 0; w < l.w; ++w) {
                    ...
                    if (l.detection) {
                        ...
                        // positive
                        grad_contrastive_loss_positive_f(z_index, l.labels, step, z, l.embedding_size, l.temperature,
                                                         l.delta + z_index, contrast_p, contrast_p_index);

                        // negative
                        grad_contrastive_loss_negative_f(z_index, l.labels, step, z, l.embedding_size, l.temperature,
                                                         l.delta + z_index, contrast_p, contrast_p_index);
                    } else {
                        // classifier
                        ...
                        grad_contrastive_loss_positive(z_index, l.labels, step, z, l.embedding_size, l.temperature,
                                                       l.cos_sim, l.p_constrastive, l.delta + b * l.inputs);
