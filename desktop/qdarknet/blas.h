...
void
grad_contrastive_loss_positive_f(size_t i, int *labels, size_t num_of_samples, float **z, unsigned int feature_size,
                                 float temperature, float *delta, contrastive_params *contrast_p, int contrast_p_size);
void
grad_contrastive_loss_negative_f(size_t i, int *labels, size_t num_of_samples, float **z, unsigned int feature_size,
                                 float temperature, float *delta, contrastive_params *contrast_p, int contrast_p_size);
...
void grad_contrastive_loss_positive(size_t i, int *labels, size_t num_of_samples, float **z, unsigned int feature_size,
                                    float temperature, float *cos_sim, float *p_constrastive, float *delta);
