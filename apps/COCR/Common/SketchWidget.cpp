...
SketchWidget::SketchWidget(QWidget *parent, QPen *_pen, QColor *_bgColor)
    ...
    qRegisterMetaType<ui_script_type>("QList<QList<QPointF>>");
    currentScript = cocrSettings.value("sketch_widget/last_script", QVariant::fromValue(
...
//                case QMessageBox::No:
//                    ptsList.clear();
//                    cocrSettings.setValue("sketch_widget/last_script", QVariant::fromValue(ptsList));
//                    sync();
//                    break;
//                default:
//                    break;
...
void SketchWidget::reset() {
    currentScript.clear();
    cocrSettings.setValue("sketch_widget/last_script", QVariant::fromValue(currentScript));
    sync();
}
