...
// Function Prototype
void train(po::variables_map &vm, torch::Device &device, VariationalAutoEncoder &model,
           std::vector<transforms_Compose > &transform);

void test(po::variables_map &vm, torch::Device &device, VariationalAutoEncoder &model,
          std::vector<transforms_Compose > &transform);

void synth(po::variables_map &vm, torch::Device &device, VariationalAutoEncoder &model);

void sample(po::variables_map &vm, torch::Device &device, VariationalAutoEncoder &model);
