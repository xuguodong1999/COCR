...
// Function Prototype
void train(po::variables_map &vm, torch::Device &device, GAN_Generator &gen, GAN_Discriminator &dis,
...
po::options_description parse_arguments() {
    ...
    args.add_options()
            ...
            ("synth_result_dir", po::value<std::string>()->default_value("synth_result"),
             "synthesis result directory : ./<synth_result_dir>")
            ("synth_sigma_max", po::value<float>()->default_value(3.0),
             "maximum value of latent variable for output images in synthesis")
            ("synth_sigma_inter", po::value<float>()->default_value(0.5),
             "the interval of latent variable for output images in synthesis")
            ...
            ("sample_result_dir", po::value<std::string>()->default_value("sample_result"),
             "sampling result directory : ./<sample_result_dir>")
            ("sample_total", po::value<size_t>()->default_value(100),
             "total number of data obtained by random sampling")
