#ifndef _BONDITEM_HPP_
#define _BONDITEM_HPP_
...
protected:
    BondItem(const string &_bondType);
...
public:
    ...
    static shared_ptr<BondItem> GetBond(const string &_bondType = "Single");
