...
function(xgd_build_rdkit_internal RDKIT_COMPONENT)
    ...
    xgd_link_libraries(${RDKIT_COMPONENT_TARGET} PRIVATE boost_serialization PUBLIC boost_header)
...
xgd_link_libraries(rdkit_FileParsers PRIVATE maeparser rapidjson)
xgd_link_libraries(rdkit_RDGeneral PRIVATE boost_stacktrace)
xgd_link_libraries(rdkit_RDStreams PUBLIC boost_iostreams)
xgd_link_libraries(rdkit_MolInterchange PRIVATE rapidjson)
xgd_link_libraries(rdkit_Descriptors PRIVATE eigen)
xgd_link_libraries(rdkit_PBF PRIVATE eigen)
xgd_link_libraries(rdkit_MolTransforms PUBLIC eigen)
xgd_link_libraries(rdkit_GraphMol PUBLIC ringdecomposerlib)
