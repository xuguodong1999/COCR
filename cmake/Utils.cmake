...
function(makeLibrary DIRECTORY_NAME LIBRARY_NAME)
    ...
    set(${LIBRARY_NAME}_INCLUDE_DIR ${CMAKE_CURRENT_SOURCE_DIR} CACHE INTERNAL "")
...
function(addLibraryDeps ORIGIN THIRD_PARTY)
    ...
    target_link_libraries(${ORIGIN} PRIVATE ${THIRD_PARTY})
    target_include_directories(${ORIGIN} PRIVATE ${${THIRD_PARTY}_INCLUDE_DIR})
endfunction()